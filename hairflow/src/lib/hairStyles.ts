// 헤어스타일 카탈로그 - 남성/여성 전체 스타일 (2024-2025 한국 트렌드 기반)
...
export const HAIR_STYLE_CATALOG: HairStyleOption[] = [
    ...
    { id: 'gail-cut', name: '가일컷', nameEn: 'Korean gail cut, short neat sides, textured top swept to one side, clean sharp modern masculine look', category: '숏', gender: 'M', description: '깔끔하고 남성적인 숏컷' },
    ...
    { id: 'leaf-cut', name: '리프컷', nameEn: 'Korean leaf cut, layered medium hair falling like leaves, natural texture, soft face-framing, trendy youthful look', category: '미디엄', gender: 'M', description: '나뭇잎처럼 흩날리는 레이어드' },
    ...
    { id: 'as-perm', name: '애즈펌', nameEn: 'Korean as perm, natural messy curls with volume, medium length, effortlessly tousled look, soft S-waves', category: '펌', gender: 'M', description: '자연스러운 흐트러짐의 컬 펌' },
    ...
    { id: 'two-block-fade', name: '투블럭 페이드', nameEn: 'Two-block fade, disconnected undercut with gradual fade, long textured top, Korean trendy style', category: '언더컷', gender: 'M', description: '투블럭 + 페이드 조합' },
    ...
    { id: 'tassel-cut', name: '태슬컷', nameEn: 'Korean tassel cut, blunt chin-length bob with slight inward curl at ends, clean sleek finish, face-framing', category: '숏', gender: 'F', description: '턱 라인을 따라 떨어지는 태슬' },
    ...
    { id: 'outside-curl', name: '외쿨펌 (바깥컬)', nameEn: 'Outward curl perm at ends, medium length, ends flipped outward, playful casual look, Korean trend', category: '미디엄', gender: 'F', description: '끝을 바깥으로 튀긴 캐주얼 스타일' },
    ...
    { id: 'volume-magic', name: '볼륨매직', nameEn: 'Volume magic straight, long sleek pin-straight hair with natural volume at roots, silky glossy finish, healthy shine', category: '롱', gender: 'F', description: '뿌리 볼륨 + 매끈한 스트레이트' },
    ...
    { id: 'build-perm', name: '빌드펌', nameEn: 'Korean build perm, voluminous layered waves building from mid-length, natural bounce, modern trendy finish', category: '펌', gender: 'F', description: '중간부터 풍성하게 쌓이는 웨이브' },
    { id: 'wave-perm', name: '물결펌', nameEn: 'Korean wave perm, soft natural water-wave pattern, medium to long, gentle S-curves throughout, effortless feminine look', category: '펌', gender: 'F', description: '물결처럼 자연스러운 웨이브' },
